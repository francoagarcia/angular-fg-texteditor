/*! angular-fg-texteditor - v1.0.0 - 2016-09-01
...
(function() {
	...
	Selection = (function(_super) {
		...
		Selection.prototype.range = function(range) {
			...
			} else if (!this._range && this.editor.inputManager.focused && this.sel.rangeCount) {
				...
				if (!pasteContent) {
					...
					if (pasteContent.is('p')) {
						...
						if (dataURLtoBlob && $img.is('img[src^="data:image/png;base64"]')) {
							...
							blob.name = "imagenesPortapapeles.png";
							uploadOpt = {};
	...
	TitleButton = (function(_super) {
		...
		TitleButton.prototype.title = 'Titulo';
	...
	BoldButton = (function(_super) {
		...
		BoldButton.prototype.title = 'Negrita';
	...
	ItalicButton = (function(_super) {
		...
		ItalicButton.prototype.title = 'Cursiva';
	...
	UnderlineButton = (function(_super) {
		...
		UnderlineButton.prototype.title = 'Subrayado';
	...
	OrderListButton = (function(_super) {
		...
		OrderListButton.prototype.title = 'Numeración';
	...
	UnorderListButton = (function(_super) {
		...
		UnorderListButton.prototype.title = 'Viñetas';
	...
	BlockquoteButton = (function(_super) {
		...
		BlockquoteButton.prototype.title = 'Texto citado';
	...
	LinkButton = (function(_super) {
		...
		LinkButton.prototype.title = 'Enlace';
	...
	LinkPopover = (function(_super) {
		...
		LinkPopover.prototype._tpl = "<div class=\"link-settings\">\n  <div class=\"settings-field\">\n    <label>Enlace</label>\n    <input class=\"link-text\" type=\"text\"/>\n    <a class=\"btn-unlink\" href=\"javascript:;\" title=\"Quitar enlace\" tabindex=\"-1\"><span class=\"fa fa-unlink\"></span></a>\n  </div>\n  <div class=\"settings-field\">\n    <label>Enlace</label>\n    <input class=\"link-url\" type=\"text\"/>\n  </div>\n</div>";
	...
	ImageButton = (function(_super) {
		...
		ImageButton.prototype.title = 'Imagen';
		...
		ImageButton.prototype.renderMenu = function() {
			...
			createInput = function() {
				...
				return $input = $('<input type="file" title="Imagen" name="upload_file" accept="image/*">').appendTo($uploadItem);
			};
			createInput();
		...
		ImageButton.prototype._initUploader = function() {
			...
			this.editor.uploader.on('beforeupload', function(e, file) {
				...
				return _this.editor.uploader.readImageFile(file.obj, function(img) {
					...
					prepare = function() {
						var $progress;
						_this.popover.srcEl.val('Subiendo...');
	...
	ImagePopover = (function(_super) {
		...
		ImagePopover.prototype._initUploader = function() {
			...
			createInput = function() {
				...
				return _this.input = $('<input type="file" title="Subiendo imagen" name="upload_file" accept="image/*">').appendTo($uploadBtn);
			};
			createInput();
	...
	IndentButton = (function(_super) {
		...
		IndentButton.prototype.title = 'Sangría derecha(Tab)';
	...
	OutdentButton = (function(_super) {
		...
		OutdentButton.prototype.title = 'Sangria izquierda（Shift + Tab）';
	...
	HrButton = (function(_super) {
		...
		HrButton.prototype.title = 'Linea separadora';
	...
	TableButton = (function(_super) {
		...
		TableButton.prototype.title = 'Tabla';
	...
	/*	FontScaleButton = (function(superClass) {
		__extends(FontScaleButton, superClass);
	...
	ColorButton = (function(superClass) {
		__extends(ColorButton, superClass);
	...
	StrikethroughButton = (function(_super) {
		...
		StrikethroughButton.prototype.title = 'Texto tachado';
